...
/* harmony import */ var _mui_icons_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @mui/icons-material */ "../../node_modules/@mui/icons-material/esm/SignalCellularAlt.js");
/* harmony import */ var _mui_icons_material__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @mui/icons-material */ "../../node_modules/@mui/icons-material/esm/Block.js");
/* harmony import */ var _utilities_getCfg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utilities/getCfg */ "./src/utilities/getCfg.js");
/* harmony import */ var _mckennatim_mqtt_hooks_src__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../@mckennatim/mqtt-hooks/src */ "../@mckennatim/mqtt-hooks/src/index.js");
/* harmony import */ var _appInit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../appInit */ "./src/appInit.js");
...
var lsh = _utilities_getCfg__WEBPACK_IMPORTED_MODULE_1__.ls.getItem();
...
function Control() {
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("blur-disconnected"),
    _useState4 = _slicedToArray(_useState3, 2),
    status = _useState4[0],
    setStatus = _useState4[1];
  var _useContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_mckennatim_mqtt_hooks_src__WEBPACK_IMPORTED_MODULE_2__.Context),
    _useContext2 = _slicedToArray(_useContext, 2),
    client = _useContext2[0],
    publish = _useContext2[1];
  client.onMessageArrived = onMessageArrived;
  var _useReducer = (0,react__WEBPACK_IMPORTED_MODULE_0__.useReducer)(reducer, _appInit__WEBPACK_IMPORTED_MODULE_3__.initialState),
  ...
  function onMessageArrived(message) {
    var _processMessage = (0,_mckennatim_mqtt_hooks_src__WEBPACK_IMPORTED_MODULE_2__.processMessage)(message, devs, state),
    ...
    if (dev == _appInit__WEBPACK_IMPORTED_MODULE_3__.dev1) {
      setConnected(true);
    }
    console.log('dev: ', dev, 'dev1: ', _appInit__WEBPACK_IMPORTED_MODULE_3__.dev1, 'connected: ', connected);
    if (nsarr.length > 0) {
  ...
  var _useDevSpecs = (0,_mckennatim_mqtt_hooks_src__WEBPACK_IMPORTED_MODULE_2__.useDevSpecs)(_utilities_getCfg__WEBPACK_IMPORTED_MODULE_1__.ls, _utilities_getCfg__WEBPACK_IMPORTED_MODULE_1__.cfg, client, function (devs, zones) {
      if (!client.isConnected()) {
        (0,_mckennatim_mqtt_hooks_src__WEBPACK_IMPORTED_MODULE_2__.connect)(client, lsh, function (client) {
          if (client.isConnected()) {
            (0,_mckennatim_mqtt_hooks_src__WEBPACK_IMPORTED_MODULE_2__.setupSocket)(client, devs, publish, topics, function (devs, client) {
  ...
  var goSignin = function goSignin() {
    var href = (0,_utilities_getCfg__WEBPACK_IMPORTED_MODULE_1__.makeHref)(window.location.hostname, "signin", "");
  ...
  var toggleOnOff = function toggleOnOff(typ) {
    return function () {
      ...
      console.log("typ: ", typ);
      var di = (0,_mckennatim_mqtt_hooks_src__WEBPACK_IMPORTED_MODULE_2__.getDinfo)(typ, devs);
      console.log("di: ", di);
  ...
  var handleNewTstat = function handleNewTstat(key) {
    return function (event) {
      if (event.key === 'Enter') {
        ...
        var di = (0,_mckennatim_mqtt_hooks_src__WEBPACK_IMPORTED_MODULE_2__.getDinfo)(key, devs);
        console.log('di: ', di);
    ...
    if (!error) {
      ...
      var listData = Object.keys(state).map(function (key, i) {
        if (devs) {
          ...
          var darr = "[";
          if (ctype) {
            var clen = _appInit__WEBPACK_IMPORTED_MODULE_3__.ctrltypes[ctype]["cmd"].length;
            _appInit__WEBPACK_IMPORTED_MODULE_3__.ctrltypes[ctype]["cmd"].map(function (c, j) {
          ...
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
            key: i
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, di.dev, " ", di.sr, " ", key, " ", ctype, " ", darr), crInput(), state[key].pro && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, " pro: ", JSON.stringify(state[key].pro), " [", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
            size: "20",
            type: "text",
            onKeyDown: handleNewProg(key)
          }), " ]"), state[key].timeleft >= 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, " timeleft:  ", JSON.stringify(state[key].timeleft), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
            size: "1",
            type: "text",
            onKeyDown: handleTsec(key)
          }))));
        }
      });
  ...
  var rrender = function rrender() {
    if (!error) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header", {
        ...
        style: styles.ur
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material__WEBPACK_IMPORTED_MODULE_4__["default"], null)) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        style: styles.ur
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material__WEBPACK_IMPORTED_MODULE_5__["default"], null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        style: styles.ll
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        style: styles.txt
  ...
  }, rrender(), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", null, "Control"), renderControl());
}
var styles = {
  ctrl: {
    div0: {
